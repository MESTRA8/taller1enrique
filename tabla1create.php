...
<body>
        ...
        <div class="contenedor">
            <div class="barra">
                <a class="logo">
                    ...
                    <h3 class="logo__nombre no-margin centrar-texto logo__bold">TABLA 1: Crear</h3>
                </a>
    ...
    <div class="contenedor ">
        <form class="formulario" method="POST" action="includes/tabla1/insertar.php">

            <div class="campo">
                <label class="campo_label" for="nombres"> Nombre: </label>
                <input class="campo_field" name="nombre" type="text" placeholder="Tu nombres" id="nombres">
            </div>

            <div class="campo">
                <label class="campo_label" for="apellidos"> Apellido: </label>
                <input class="campo_field" name="apellido" type="text" placeholder="Tu apellidos" id="apellidos">
            </div>
